...
with open('autoencoderFullyConnectedOneEpoch7Sep.obj','wb') as f:
    pickle.dump(result_files,f)
write_result(algorithm_name='autoencoderFullyConnectedOneEpoch7Sep',data_files=result_files,results_path=cwd+'/results')